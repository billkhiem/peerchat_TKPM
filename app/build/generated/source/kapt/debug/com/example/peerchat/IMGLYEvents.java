...
public class IMGLYEvents extends ly.img.android.pesdk.backend.model.state.manager.ImglyEventDispatcher {
    ...
    protected Class<?> getEventSetClass(Object object) {
        ...
        Class<?> eventSetClass = com.example.peerchat.events.$EventAccessorMap.classAccessorsMap.get(modelClass);
        while (eventSetClass == null) {
            modelClass = modelClass.getSuperclass();
            eventSetClass = com.example.peerchat.events.$EventAccessorMap.classAccessorsMap.get(modelClass);
    ...
    public static final String UiStateMenu="UiStateMenu";
    ...
    public static final String FilterSettings="FilterSettings";
    ...
    public static final String TextDesignLayerSettings="TextDesignLayerSettings";
    ...
    public static final String BrushSettings="BrushSettings";
    ...
    public static final String UiStateSticker_="UiStateSticker.";
    ...
    public static final String FocusSettings="FocusSettings";
    ...
    public static final String ColorAdjustmentSettings="ColorAdjustmentSettings";
    ...
    public static final String TextLayerSettings="TextLayerSettings";
    ...
    public static final String FrameSettings="FrameSettings";
    ...
    public static final String ImageStickerLayerSettings="ImageStickerLayerSettings";
