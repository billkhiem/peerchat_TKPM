...
import com.example.peerchat.CustomView.DrawingView;

public class DrawingActivity extends Activity {
	private static final String TAG = "com.example.peerchat.DrawingActivity";
	...
	private void saveDrawing(){
		...
		newDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener(){
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				String path = com.example.peerchat.DrawingActivity.this.getExternalFilesDir(Environment.DIRECTORY_PICTURES).getAbsolutePath();
				String fileName = FileUtilities.fileName() + ".jpg";
				FileUtilities.saveImageFromBitmap(com.example.peerchat.DrawingActivity.this, drawView.getDrawingCache(), path, fileName);
